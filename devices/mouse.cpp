...
Mouse::Mouse()
    : Device{L"\\\\?\\HID#VARIABLE_6&Col02#1&1302b6b5"}
{}
...
int Mouse::getRangeBySpeed(int speed)
{
    ...
    int sensitivity = RegistryService::getMouseSensivity();
    int eppSpeed = RegistryService::getMouseSpeed();
